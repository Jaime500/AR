...
public class DevelopAzureSpatialAnchorsScript : MonoBehaviour
{
    ...
    private void SpatialAnchorManager_AnchorLocated(object sender, AnchorLocatedEventArgs args)
    {
        ...
        if (args.Status == LocateAnchorStatus.Located)
        {
            ...
            UnityDispatcher.InvokeOnAppThread(() =>
            {
                ...
                sensorObject.GetComponentInChildren<Sensor_Update>().deviceId = "70886b123507";
                sensorObject.GetComponentInChildren<Sensor_Update>().deviceClass = 0;
                Debug.Log("Sensor ID: " + sensorObject.GetComponent<Sensor_Update>().deviceId);
                Debug.Log("Sensor type: " + sensorObject.GetComponent<Sensor_Update>().deviceClass);
                sensorObject.transform.localPosition = new Vector3(0, 0, 1);
            });
        }
    }
    // </SpatialAnchorManagerAnchorLocated>
