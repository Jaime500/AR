...
public class Sensor_Update : MonoBehaviour
{
    ...
    async Task<string> get_data(string sensor_type, string device_id)
    {
        ...
        string query = "SELECT value FROM \"" + sensor_type + "\" WHERE device_id = '" + device_id + "' ORDER BY time DESC LIMIT 1;";
    ...
    async void update_awair()
    {
        ...
        await Task.WhenAll(response0, response1, response2, response3, response4, response5);
    ...
    async void update_temp_humid()
    {
        ...
        await Task.WhenAll(response0, response1);
    ...
    async void update_light()
    {
        ...
        await Task.WhenAll(response0, response2);
